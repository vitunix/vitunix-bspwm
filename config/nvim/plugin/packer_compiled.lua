...
_G.packer_plugins = {
  ...
  ["cmp-emmet-vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/cmp-emmet-vim",
  ...
  ["deoplete-clang"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/deoplete-clang",
  ...
  ["vim-system-copy"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-system-copy",
